...
$this->title = 'Tìm kiếm : '.$textSearch ;
?>
            ...
            <div class="col-sm-24">
                <div class="breadcrumbs">
                    <ul>
                        ...
                        <li class="contact"> <strong>Tìm kiếm : <?php echo $textSearch ?></strong>
                        </li>
                    </ul>
                </div>
            </div>
...
<div class="em-wrapper-main">
    <div class="container-main">
        <input type="hidden" value="<?php echo $textSearch ?>" name="textSearch" />
