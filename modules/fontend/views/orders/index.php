                                    ...
                                    <form id="co-billing-form">
                                        <fieldset>
                                            ...
                                            <div class="buttons-set" id="billing-buttons-container">
                                                ...
                                                </button> <span class="please-wait" id="billing-please-wait" style="display:none;"> <img src="<?php echo Url::base('http') ?>/upload/images/opc-ajax-loader.html" alt="Loading next step..." title="Loading next step..." class="v-middle" /> Loading next step... </span>
                                            </div>
                                        </fieldset>
                                    </form>
