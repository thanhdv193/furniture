    ...
    public static function Image($product_id = 0, $start = 0, $limit = 1)
    {
        ...
        } else
        {
            if(count($list) >= 2)
            {
                ...
                echo '<img class="em-alt-hover img-responsive em-lazy-loaded" src="' .Url::base('http'). $value['image_path'] . '' . $value['filename'] . '" data-original="upload/images/product/350x350/clothing_sp5_2.jpg" alt=" Embellished Mirror Pastel" height="350" width="350">';
            }
