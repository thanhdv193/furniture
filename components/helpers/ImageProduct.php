    ...
    public static function Image($product_id = 0, $start = 0, $limit = 1)
        ...
        if ($list == null)
            ...
            foreach ($list as $key => $value)
                ...
                if ($key == 1)
                    {
                    echo '<img class="img-responsive em-alt-org em-lazy-loaded" src="' . $value['image_path'] . '' . $value['filename'] . '" data-original="upload/images/product/350x350/clothing_sp5_1.jpg" alt=" Embellished Mirror Pastel" height="350" width="350">';
                    } else
                    {
